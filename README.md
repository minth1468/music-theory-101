...
![alt text](https://github.com/minth1468/music-theory-101/blob/main/assets/image-20240318185437005.png?raw=true)
...
| Frequency | Note name | Frequency (In order) | Note name |
| --------- | --------- | -------------------- | --------- |
| 440.00    | A         | 440.00               | A         |
| 660.00    | E         | 469.86               | Bb        |
| 495.00    | B         | 495.00               | B         |
...
A 446Hz is obtained after 12 iterations and is close enough to starting frequency (440Hz), thus an Octave can be divided into 12 pitches.

However, the distance of 12 the pitches are not equal. To obtain a equal temperament, the Recurrence Equation should be $f_{n+1}=f_n\times2^{1/12}$ .
